...
;(async () => {
  ...
  program
    .description('Subset and convert from ttf/otf font files to woff2 format')
  ...
  const srcFilePathList = await glob(join(srcDirPath, '**/*.{ttf,otf}'))
